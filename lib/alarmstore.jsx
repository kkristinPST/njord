...
const ALARM_REGISTER_SEED = [
  ...
  { id: "AL07", t: "04/03/2026 12:39:57", since: 0.40, area: "DPT1 Lye",                   tag: "DPT1-DNA0-PU2", alarm: "Lye pump 2 General fault from pump",               level: "high",       state: "ack",   supp: "none", meas: null },
  { id: "AL08", t: "04/03/2026 12:36:22", since: 0.60, area: "DPT1 Pump Sump",            tag: "DPT1-SMP0-PU1", alarm: "Lift pump 1 High temperature",             level: "high",       state: "unack", supp: "none", meas: { tag: "DPT1-SMP0-PU1", name: "Lift pump 1 winding temp", unit: "°C", base: 58, amp: 4.5, group: "Pump Sump", thr: { value: 75, kind: "hi" } } },
